...
import cv2
import numpy as np
from descripteur import concatenation
...
def ExtractionSignatures(chemin_repertoire):
    ...
    np.save('SignaturesConcat.npy', signatures)
    print("Signatures sauvegardées dans SignaturesConcat.npy")
